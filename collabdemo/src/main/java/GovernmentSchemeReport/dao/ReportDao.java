...
import GovernmentSchemeReport.model.GovernmentScheme;
import GovernmentSchemeReport.model.GovernmentSchemeApplication;
import org.hibernate.SessionFactory;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Repository;
...
public class ReportDao {
    ...
    public List<Integer> getFarmerIds() {
        String hql = "SELECT DISTINCT s.farmer.id FROM GovernmentSchemeReport s";
    ...
    @Transactional
    public String getFarmerName(Integer farmerId) {
        String hql = "SELECT u.name FROM ReportUser u WHERE u.id = :farmerId";
        return sessionFactory.getCurrentSession()
    ...
    @Transactional
    public List<String> getSchemeTitlesByFarmer(Integer farmerId) {
        String hql = "SELECT s.scheme.title FROM GovernmentSchemeReport s WHERE s.farmer.id = :farmerId";
        return sessionFactory.getCurrentSession()
                .createQuery(hql, String.class)
                .setParameter("farmerId", farmerId)
                .getResultList();
